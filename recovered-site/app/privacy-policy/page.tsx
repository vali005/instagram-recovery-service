...
const collectedFields: { term: string; description: string }[] = [
  ...
  {
    term: "Дополнительный способ связи (необязательно)",
    description:
      "Можно указать контакт, только если ответ нужен не в том мессенджере, через который вы отправляете обращение.",
  },
  {
    term: "Согласие на обработку",
    description:
      "Отметка подтверждает, что вы понимаете: сайт готовит черновик локально, а передача во внешний сервис происходит только после вашего отдельного действия.",
  },
];
          ...
          <div className="mx-auto max-w-4xl space-y-12">
            ...
            <section aria-labelledby="pp-why" className="scroll-mt-24">
              ...
              <p className="mt-3 text-base leading-7 text-slate-600">
                Единственная цель — составить понятный текст вашего обращения и, после самостоятельной отправки, ответить на него.
            ...
            <section aria-labelledby="pp-consent" className="scroll-mt-24">
              ...
              <p className="mt-3 text-base leading-7 text-slate-600">
                Отмечая подтверждение в форме, вы соглашаетесь использовать введённые данные для подготовки
                и ответа на обращение. Передача во внешний сервис происходит только после того, как вы сами отправили
